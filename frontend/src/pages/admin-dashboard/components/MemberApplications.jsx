  ...
  if (error && applications.length === 0) {
    return (
      <div className="text-center py-12">
        <Icon name="AlertOctagon" size={48} className="text-error mx-auto mb-4" />
            ...
            <tbody>
              {filteredApplications.map((application) => (
                <tr key={application._id} className="border-b border-border hover:bg-background transition-smooth">
                  ...
                  <td className="p-4">
                    <div className="flex items-center space-x-2">
                      {application.documentPhoto ? (
                        <a
                          href={application.documentPhoto}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="flex items-center space-x-1 px-2 py-1 bg-accent hover:bg-secondary hover:text-white text-secondary text-xs rounded transition-smooth"
                        >
                      ...
                      {application.isOTPVerified && (
                        <Icon name="Shield" size={16} className="text-success" title="Phone Verified" />
                      )}
                    </div>
                  </td>
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="font-medium text-text-primary">{member.applicationId || 'Not assigned'}</p>
            </div>
          </div>
        </div>

        {/* Youth Leadership Program Information */}
        {member.membershipType === 'Kisan Youth Leadership Program' && (
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-primary">Youth Program Information</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <p className="text-sm text-text-secondary">Age</p>
                <p className="font-medium text-text-primary">{member.age || 'Not provided'}</p>
              </div>
              <div>
                <p className="text-sm text-text-secondary">Education</p>
                <p className="font-medium text-text-primary">{member.education || 'Not provided'}</p>
              </div>
              <div className="col-span-2">
                <p className="text-sm text-text-secondary">Agricultural Experience</p>
                <p className="font-medium text-text-primary">{member.experience || 'Not provided'}</p>
              </div>
            </div>
          </div>
        )}
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <p className="text-sm text-text-secondary">Phone Verified</p>
              <p className="font-medium text-text-primary">{member.isOTPVerified ? 'Yes' : 'No'}</p>
            </div>
          </div>
          ...
          {member.documentPhoto && (
            <div className="mt-4">
              ...
              <div className="mt-2">
                <a
                  href={member.documentPhoto}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center space-x-2 text-primary hover:text-secondary transition-smooth"
                >
