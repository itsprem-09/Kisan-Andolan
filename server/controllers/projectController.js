...
const createProject = asyncHandler(async (req, res) => {
  try {
    ...
    const { name, description, budget, targetFarms, expectedStartDate, status, location, gallery } = req.body;
...
const updateProject = asyncHandler(async (req, res) => {
  ...
  project.expectedStartDate = expectedStartDate || project.expectedStartDate;
